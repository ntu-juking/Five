...
res\chess.ico
    ...
    icon is included by the main resource file chess.rc.
...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in chess.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////

AppWizard creates one document type and one view:

chessDoc.h, chessDoc.cpp - the document
    These files contain your CChessDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CChessDoc::Serialize).

chessView.h, chessView.cpp - the view of the document
